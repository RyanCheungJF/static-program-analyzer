...
//         ParameterType::ASSIGN)}; shared_ptr<Relationship> rs4 = Relationship::makeRelationship(AppConstants::AFFECTS,
//         params4); std::vector<std::vector<std::string>> res4 = readPkb.findRelationship(rs4); REQUIRE(res4.empty());
//     }
//
//     SECTION("Affects*(a, int)") {
//         std::vector<Parameter> params1 = {Parameter("a", ParameterType::ASSIGN),
...
//         std::vector<Parameter> params4 = {Parameter("a", ParameterType::ASSIGN), Parameter("a",
//         ParameterType::ASSIGN)}; shared_ptr<Relationship> rs4 = Relationship::makeRelationship(AppConstants::AFFECTS,
//         params4); std::vector<std::vector<std::string>> res4 = readPkb.findRelationship(rs4);
...
//         Relationship::makeRelationship(AppConstants::AFFECTST, params4); std::vector<std::vector<std::string>> res4 =
//         readPkb.findRelationship(rs4); std::vector<std::vector<std::string>> expected4 = {{"20", "20"}};
//         REQUIRE(unit_testing_utils::equals(expected4, res4));
//     }
// }
