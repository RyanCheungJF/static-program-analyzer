...
TEST_CASE("CFGStorage, ReadPKB, WritePKB, no while loop") {
    ...
    CFGNodeStub root;
    root.first = 1; root.last = 2;
    CFGNodeStub node1;
    node1.first = 3; node1.last = 4;
    CFGNodeStub node2;
    node2.first = 5; node2.last = 6;
    CFGNodeStub node3;
    node3.first = 7; node3.last = 9;
    CFGNodeStub node4;
    node4.first = 10; node4.last = 12;
    CFGNodeStub node5;
    node5.first = 13; node5.last = 13;
