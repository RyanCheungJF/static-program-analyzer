...
TEST_CASE("findRelationship(shared_ptr<Relationship> rs), Follows and FollowsT") {
    ...
    // Follows
    std::vector<Parameter> params1 = {Parameter("1", ParameterType::FIXED_INT), Parameter("_", ParameterType::WILDCARD)};
    shared_ptr<Relationship> rs1 = Relationship::makeRelationship(AppConstants::FOLLOWS, params1);

    // FollowsT
    std::vector<Parameter> params2 = {Parameter("1", ParameterType::FIXED_INT), Parameter("_", ParameterType::WILDCARD)};
