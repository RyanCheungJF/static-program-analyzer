...
TEST_CASE("Support for pattern query of type pattern(\"a\", _\"v\"_)") {
    ...
    QueryStub qs3;
    qs3.lhs = "z";
    qs3.pattern = "_*_"; // in general, this is also failing for non-complete terms eg "* 5", "+ b", "/ c"
...
TEST_CASE("Support for pattern query of type pattern(_, _\"v\"_)") {
    ...
    QueryStub qs2;
    qs2.lhs = "_";
    qs2.pattern = "_ * _"; // in general, this is also failing for non-complete terms eg "* 5", "+ b", "/ c"
