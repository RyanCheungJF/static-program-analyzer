...
void EntRefExtractorVisitor::visitPrintStatement(
...
void EntRefExtractorVisitor::visitAssignStatement(
  ...
  writeApi->writePattern(assignStatement->varName,
                         assignStatement->statementNumber, std::move(expr));
}
...
void EntRefExtractorVisitor::visitWhileStatement(
...
void EntRefExtractorVisitor::visitConditionalExpression(
