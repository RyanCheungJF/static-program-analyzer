...
std::vector<std::vector<std::string>> PKB::findPattern(Pattern& p) {
    ...
    if (patternSyn.isAssign()) {
        ...
        std::cout << "\n\nAssign Pattern Handler: " + p.getPatternSyn()->getValue() + "(" + p.getEntRefValue() + ", " + p.getExprSpecs()[0] + ")\n";
        for (std::vector<std::string> curr : res) {
            std::cout << "{" << curr[0] + ", " << curr[1] << "}\n";
        }
        std::cout << "\n";
        ...
        std::cout << "\n\nIfWhile Pattern Handler: " + p.getPatternSyn()->getValue() + "(" + p.getEntRefValue() + ", " + p.getExprSpecs()[0] + ")\n";
        for (std::vector<std::string> curr : res) {
            std::cout << "{" << curr[0] + ", " << curr[1] << "}\n";
        }
        std::cout << "\n";
