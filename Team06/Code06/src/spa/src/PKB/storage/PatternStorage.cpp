...
std::unordered_set<std::pair<int, std::unique_ptr<Expression>>, hashFunction>* PatternStorage::getPatternWithLHS(std::string lhs) {
...
std::unordered_map<std::string, std::unordered_set<std::pair<int, std::unique_ptr<Expression>>, hashFunction>>* PatternStorage::getAll() {
