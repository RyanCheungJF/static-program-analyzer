#include "UsesStorageOld.h"

/* Helper Functions */
std::vector<std::vector<std::string>> UsesStorageOld::getUsesAllStatements(StmtType type) {
...
std::vector<std::vector<std::string>> UsesStorageOld::getUsesAllStatementsGivenProcedure(StmtType type, ProcedureName name) {
    std::vector<std::vector<std::string>> res; // {stmtNum, var}
...
std::vector<std::vector<std::string>> UsesStorageOld::getUsesAllStatementsGivenEntity(StmtType type, Ent entity) {
    std::vector<std::vector<std::string>> res; // {stmtNum, var}
...
void UsesStorageOld::writeUses(ProcedureName name, StmtType type, StmtNum num, Ent ent) {
...
void UsesStorageOld::writeUsesCall(ProcedureName caller, ProcedureName callee, StmtNum num) {
...
std::unordered_set<std::string> UsesStorageOld::getAllEntitiesUsed(ProcedureName name) {
...
bool UsesStorageOld::checkUses(StmtNum num, Ent e) {
...
bool UsesStorageOld::checkUses(ProcedureName name, Ent e) {
...
std::vector<std::vector<std::string>> UsesStorageOld::getUsesAllPrintStatements() {
    return getUsesAllStatements("print");
}

std::vector<std::vector<std::string>> UsesStorageOld::getUsesAllPrintStatementsGivenProcedure(ProcedureName name) {
    return getUsesAllStatementsGivenProcedure("print", name);
}

std::vector<std::vector<std::string>> UsesStorageOld::getUsesAllPrintStatementsGivenEntity(Ent entity) {
    return getUsesAllStatementsGivenEntity("print", entity);
}

std::vector<std::vector<std::string>> UsesStorageOld::getUsesAllAssignStatements() {
    return getUsesAllStatements("assign");
}

std::vector<std::vector<std::string>> UsesStorageOld::getUsesAllAssignStatementsGivenProcedure(ProcedureName name) {
    return getUsesAllStatementsGivenProcedure("assign", name);
}

std::vector<std::vector<std::string>> UsesStorageOld::getUsesAllAssignStatementsGivenEntity(Ent entity) {
    return getUsesAllStatementsGivenEntity("assign", entity);
}

std::vector<std::vector<std::string>> UsesStorageOld::getUsesAllIfStatements() {
    return getUsesAllStatements("if");
}

std::vector<std::vector<std::string>> UsesStorageOld::getUsesAllIfStatementsGivenProcedure(ProcedureName name) {
    return getUsesAllStatementsGivenProcedure("if", name);
}

std::vector<std::vector<std::string>> UsesStorageOld::getUsesAllIfStatementsGivenEntity(Ent entity) {
    return getUsesAllStatementsGivenEntity("if", entity);
}

std::vector<std::vector<std::string>> UsesStorageOld::getUsesAllWhileStatements() {
    return getUsesAllStatements("while");
}

std::vector<std::vector<std::string>> UsesStorageOld::getUsesAllWhileStatementsGivenProcedure(ProcedureName name) {
    return getUsesAllStatementsGivenProcedure("while", name);
}

std::vector<std::vector<std::string>> UsesStorageOld::getUsesAllWhileStatementsGivenEntity(Ent entity) {
    return getUsesAllStatementsGivenEntity("while", entity);
}

//format: {StmtNum, entity}
std::vector<std::vector<std::string>> UsesStorageOld::getUsesAllCallStatements_format1() {
...
//format: {StmtNum, entity}
std::vector<std::vector<std::string>> UsesStorageOld::getUsesAllCallStatementsGivenProcedure_format1(ProcedureName name) {
    std::vector<std::vector<std::string>> res;
...
std::vector<std::vector<std::string>> UsesStorageOld::getUsesAllCallStatementsGivenProcedure_format2(ProcedureName name) {
    std::vector<std::vector<std::string>> res;
    for (auto i : procName_stmtType_stmtNum[name]["call"]) {
        std::string callee = call_callee[i];
...
std::vector<std::vector<std::string>> UsesStorageOld::getUsesAllCallStatementsGivenProcedure_format3(ProcedureName name) {
...
std::vector<std::vector<std::string>> UsesStorageOld::getUsesAllCallStatementsGivenEntity_format1(Ent entity) {
    std::vector<std::vector<std::string>> res;
    for (auto i : call_callee) {
        std::unordered_set<std::string> entities = getAllEntitiesUsed(i.second);
...
std::vector<std::vector<std::string>> UsesStorageOld::getUsesAllCallStatementsGivenEntity_format2(Ent entity) {
    std::vector<std::vector<std::string>> res;
    for (auto i : call_callee) {
        std::unordered_set<std::string> entities = getAllEntitiesUsed(i.second);
        if (entities.find(entity) != entities.end()) {
...
std::vector<std::vector<std::string>> UsesStorageOld::getUsesAllStatements() {
...
std::vector<std::vector<std::string>> UsesStorageOld::getUsesAllStatementsGivenProcedure(ProcedureName name) {
...
std::vector<std::vector<std::string>> UsesStorageOld::getUsesAllStatementsGivenEntity(Ent entity) {
