...
TEST_CASE("SP-PKB Integration: Valid Source Program, Follows, FollowsT") {
  ...
  SECTION(
      "SP-PKB Integration: Valid Source Program, Follows, FollowsT: Follows") {
    // Follows
    ...
    shared_ptr<Relationship> followsTest1 =
        Relationship::makeRelationship(AppConstants::FOLLOWS, params1);
    std::vector<std::vector<std::string>> follows1actual =
        readPKB.findRelationship(followsTest1);
    REQUIRE(follows1actual.empty());

    shared_ptr<Relationship> followsTest2 = Relationship::makeRelationship(
        AppConstants::FOLLOWS, {Parameter("2", AppConstants::FIXED_INT),
                                Parameter("3", AppConstants::FIXED_INT)});
    std::vector<std::vector<std::string>> follows2actual =
        readPKB.findRelationship(followsTest2);
    ...
    shared_ptr<Relationship> followsTest3 = Relationship::makeRelationship(
        AppConstants::FOLLOWS, {Parameter("4", AppConstants::FIXED_INT),
                                Parameter("5", AppConstants::FIXED_INT)});
    std::vector<std::vector<std::string>> follows3actual =
        readPKB.findRelationship(followsTest3);
    ...
    shared_ptr<Relationship> followsTest4 = Relationship::makeRelationship(
        AppConstants::FOLLOWS, {Parameter("5", AppConstants::FIXED_INT),
                                Parameter("6", AppConstants::FIXED_INT)});
    std::vector<std::vector<std::string>> follows4actual =
        readPKB.findRelationship(followsTest4);
    ...
    shared_ptr<Relationship> followsTest5 = Relationship::makeRelationship(
        AppConstants::FOLLOWS, {Parameter("4", AppConstants::FIXED_INT),
                                Parameter("6", AppConstants::FIXED_INT)});
    std::vector<std::vector<std::string>> follows5actual =
        readPKB.findRelationship(followsTest5);
    ...
    std::vector<std::vector<std::string>> follows7actual =
        readPKB.findRelationship(followsTest7);
    ...
    shared_ptr<Relationship> followsTest8 = Relationship::makeRelationship(
        AppConstants::FOLLOWS, {Parameter("_", AppConstants::WILDCARD),
                                Parameter("6", AppConstants::FIXED_INT)});
    std::vector<std::vector<std::string>> follows8actual =
        readPKB.findRelationship(followsTest8);
    ...
    shared_ptr<Relationship> followsTest9 = Relationship::makeRelationship(
        AppConstants::FOLLOWS, {Parameter("_", AppConstants::WILDCARD),
                                Parameter("_", AppConstants::WILDCARD)});
    std::vector<std::vector<std::string>> follows9actual =
        readPKB.findRelationship(followsTest9);
    ...
    shared_ptr<Relationship> followsTest10 = Relationship::makeRelationship(
        AppConstants::FOLLOWS, {Parameter("re", AppConstants::READ),
                                Parameter("_", AppConstants::WILDCARD)});
    std::vector<std::vector<std::string>> follows10actual =
        readPKB.findRelationship(followsTest10);
    REQUIRE(follows1actual.empty());

    shared_ptr<Relationship> followsTest11 = Relationship::makeRelationship(
        AppConstants::FOLLOWS, {Parameter("_", AppConstants::WILDCARD),
                                Parameter("re", AppConstants::READ)});
    std::vector<std::vector<std::string>> follows11actual =
        readPKB.findRelationship(followsTest11);
    ...
    shared_ptr<Relationship> followsTest12 = Relationship::makeRelationship(
        AppConstants::FOLLOWS, {Parameter("pn", AppConstants::PRINT),
                                Parameter("ca", AppConstants::CALL)});
    std::vector<std::vector<std::string>> follows12actual =
        readPKB.findRelationship(followsTest12);
    ...
    shared_ptr<Relationship> followsTest13 = Relationship::makeRelationship(
        AppConstants::FOLLOWS, {Parameter("s", AppConstants::STMT),
                                Parameter("ca", AppConstants::CALL)});
    std::vector<std::vector<std::string>> follows13actual =
        readPKB.findRelationship(followsTest13);
    ...
    shared_ptr<Relationship> followsTest14 = Relationship::makeRelationship(
        AppConstants::FOLLOWS, {Parameter("as", AppConstants::ASSIGN),
                                Parameter("_", AppConstants::WILDCARD)});
    std::vector<std::vector<std::string>> follows14actual =
        readPKB.findRelationship(followsTest14);
    std::vector<std::vector<std::string>> follows14expected = {{"2", "3"}};
    REQUIRE(follows14expected == follows14actual);
  }

  SECTION(
      "SP-PKB Integration: Valid Source Program, Follows, FollowsT: FollowsT") {
    // FollowsT
    shared_ptr<Relationship> followsTTest1 = Relationship::makeRelationship(
        AppConstants::FOLLOWST, {Parameter("4", AppConstants::FIXED_INT),
                                 Parameter("_", AppConstants::WILDCARD)});
    std::vector<std::vector<std::string>> followsT1actual =
        readPKB.findRelationship(followsTTest1);
    std::vector<std::vector<std::string>> followsT1expected = {{"4", "5"},
                                                               {"4", "6"}};
    ...
    shared_ptr<Relationship> followsTTest2 = Relationship::makeRelationship(
        AppConstants::FOLLOWST, {Parameter("as", AppConstants::ASSIGN),
                                 Parameter("_", AppConstants::WILDCARD)});
    std::vector<std::vector<std::string>> followsT2actual =
        readPKB.findRelationship(followsTTest2);
    ...
    shared_ptr<Relationship> followsTTest3 = Relationship::makeRelationship(
        AppConstants::FOLLOWST, {Parameter("s", AppConstants::STMT),
                                 Parameter("_", AppConstants::WILDCARD)});
    std::vector<std::vector<std::string>> followsT3actual =
        readPKB.findRelationship(followsTTest3);
    std::vector<std::vector<std::string>> followsT3expected = {
        {"2", "3"}, {"4", "5"}, {"4", "6"}, {"5", "6"}};
    ...
    shared_ptr<Relationship> followsTTest4 = Relationship::makeRelationship(
        AppConstants::FOLLOWST, {Parameter("pn", AppConstants::PRINT),
                                 Parameter("_", AppConstants::WILDCARD)});
    std::vector<std::vector<std::string>> followsT4actual =
        readPKB.findRelationship(followsTTest4);
    std::vector<std::vector<std::string>> followsT4expected = {{"4", "5"},
                                                               {"4", "6"}};
...
TEST_CASE("SP-PKB Integration: Valid Source Program, Parent, ParentT") {
  ...
  SECTION("SP-PKB Integration: Valid Source Program, Parent, ParentT: Parent") {
    ...
    shared_ptr<Relationship> parentTest1 = Relationship::makeRelationship(
        AppConstants::PARENT, {Parameter("_", AppConstants::WILDCARD),
                               Parameter("ass", AppConstants::ASSIGN)});
    std::vector<std::vector<std::string>> parent1actual =
        readPKB.findRelationship(parentTest1);
    std::vector<std::vector<std::string>> parent1expected = {
        {"4", "5"}, {"4", "6"}, {"7", "8"}, {"7", "9"}};
    ...
    std::vector<std::vector<std::string>> parent2actual =
        readPKB.findRelationship(parentTest2);
    ...
    std::vector<std::vector<std::string>> parent3actual =
        readPKB.findRelationship(parentTest3);
    ...
    shared_ptr<Relationship> parentTest4 = Relationship::makeRelationship(
        AppConstants::PARENT, {Parameter("ass", AppConstants::ASSIGN),
                               Parameter("w", AppConstants::WHILE)});
    std::vector<std::vector<std::string>> parent4actual =
        readPKB.findRelationship(parentTest4);
    REQUIRE(parent4actual.empty());

    shared_ptr<Relationship> parentTest5 = Relationship::makeRelationship(
        AppConstants::PARENT, {Parameter("w", AppConstants::WHILE),
                               Parameter("ca", AppConstants::CALL)});
    std::vector<std::vector<std::string>> parent5actual =
        readPKB.findRelationship(parentTest5);
  ...
  SECTION(
      "SP-PKB Integration: Valid Source Program, Parent, ParentT: ParentT") {

    shared_ptr<Relationship> parentTTest1 = Relationship::makeRelationship(
        AppConstants::PARENTT, {Parameter("_", AppConstants::WILDCARD),
                                Parameter("ass", AppConstants::ASSIGN)});
    std::vector<std::vector<std::string>> parentT1actual =
        readPKB.findRelationship(parentTTest1);
    std::vector<std::vector<std::string>> parentT1expected = {
        {"3", "5"}, {"3", "6"}, {"3", "8"}, {"3", "9"},
        {"4", "5"}, {"4", "6"}, {"7", "8"}, {"7", "9"}};
    ...
    shared_ptr<Relationship> parentTTest2 = Relationship::makeRelationship(
        AppConstants::PARENTT, {Parameter("_", AppConstants::WILDCARD),
                                Parameter("if", AppConstants::IF)});
    std::vector<std::vector<std::string>> parentT2actual =
        readPKB.findRelationship(parentTTest2);
    ...
    shared_ptr<Relationship> parentTTest3 = Relationship::makeRelationship(
        AppConstants::PARENTT, {Parameter("_", AppConstants::WILDCARD),
                                Parameter("w", AppConstants::WHILE)});
    std::vector<std::vector<std::string>> parentT3actual =
        readPKB.findRelationship(parentTTest3);
    ...
    shared_ptr<Relationship> parentTTest4 = Relationship::makeRelationship(
        AppConstants::PARENTT, {Parameter("ass", AppConstants::ASSIGN),
                                Parameter("w", AppConstants::WHILE)});
    std::vector<std::vector<std::string>> parent4actual =
        readPKB.findRelationship(parentTTest4);
    REQUIRE(parent4actual.empty());

    shared_ptr<Relationship> parentTTest5 = Relationship::makeRelationship(
        AppConstants::PARENTT, {Parameter("w", AppConstants::WHILE),
                                Parameter("ca", AppConstants::CALL)});
    std::vector<std::vector<std::string>> parentT5actual =
        readPKB.findRelationship(parentTTest5);
    std::vector<std::vector<std::string>> parentT5expected = {{"3", "10"},
                                                              {"7", "10"}};
